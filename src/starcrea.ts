...
export function AnimatedStars(amountN: number, TimeStart: number, DurationWall: number, StarScale: Vec3, Rand1: number, Rand2: number, DissolveEntrance: boolean, StarColorR: number, StarColorG: number, StarColorB: number){
